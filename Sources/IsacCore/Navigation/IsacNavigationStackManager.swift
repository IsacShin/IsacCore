...
/*
 - IsacNavigationStackManager.swift
...
@available(iOS 16.0, *)
@MainActor
public final class IsacNavigationStackManager: ObservableObject {
    public static let shared = IsacNavigationStackManager() // 싱글톤 인스턴스
